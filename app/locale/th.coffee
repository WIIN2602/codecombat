module.exports = nativeDescription: "ไทย", englishDescription: "Thai", translation:
  ...
  ozaria_home:
    subtitle: "ความน่าสนใจของวิทยาการคอมพิวเตอร์"
    heading_subtitle: "การผจญภัยในการเขียนโค้ดสำหรับนักเรียนและกระบวนการสอนแบบครบวงจรสำหรับวิทยาการคอมพิวเตอร์"
    item_list_p: "ทดลองบทที่1 ฟรีได้แล้ววันนี้!"
    engaging_heading_corner: "กระบวนการที่จะดึงดูดนักเรียนไปพร้อมๆกับการซัพพอร์ตคุณครูทุกท่าน"
    engaging_row1_h2: "ใช้งานง่าย"
    engaging_row1_p: "ต่อให้คุณไม่มีประสบการณ์เขียนโค้ด คุณก็สามารถสอนวิทยาการคอมพิวเตอร์ไปกับOzariaได้. แผนการสอนที่พร้อมใช้งานและแดชบอร์ดที่ใช้งานง่ายของเราจะช่วยให้คุณมีเครื่องมือการสอนที่เพียบพร้อมสำหรับวันแรกได้ทันที"
    engaging_row2_h2: "ดื่มด่ำไปกับการเล่นเกม"
    engaging_row2_p: "นักเรียนของคุณจะได้ดื่มด่ำไปกับเกมผจญภัยที่ทรอดแทรกความรู้ในศาสตร์ของวิทยาการคอมพิวเตอร์. ภายใต้สภาพแวดล้อมอันน่าดึงดูดนี้ นักเรียนของคุณจะสามารถสร้างทักษะในโลกแห่งความเป็นจริงผ่านการเล่นของพวกเขา"
    engaging_row3_h2: "หลักศุตรที่สอดคล้องไปกับมาตรฐานสากล"
    engaging_row3_p: "Ozaria นั้นถูกสร้างขึ้นภายใต้มาตรฐานของ CSTA และ ISTE ซึ่งจะทำให้นักเรียนของคุณเชี่ยวชาญทักษะและแนวคิดแบบคนคอมพิวเตอร์ ทักษะการคิดคำนวณ และสามารถที่จะเรียนรู้ความเชื่อมโยงระหว่างวิทยาการคอมพิวเตอร์กับชีวิตประจำวันของพวกเขาได้"
    pd_blurb: "คุณสามารถเรียนรู้การสอนวิทยาการคอมพิวเตอร์อย่างมีประสิทธิภาพเป็นเวลา40ชั่วโมงจากอุกปรณ์ใดก็ได้ ด้วยหลักสูตร __pd__ ที่ได้รับการรับรองจากCSTAด้วยตัวของคุณเอง"
    back_cta_1_a: "ทดลองบทที่ 1 ฟรี!"
    speech_bubble_testimonial_1_blockquote: "เป็นอีกครั้งที่ทีมของคุณประสบความสำเร็จในความใฝ่ฝันสูงสุดของวงการการศึกษา ในความคิดของฉันที่ได้เป็นครูของระดับชั้นมัธยมศึกษามา26ปีไม่มีแหล่งข้อมูลใดที่น่าสนใจสำหรับการสอนเขียนโค้ดได้มากกว่าที่นี่อีกแล้ว"
    core_curriculum_header: "หลักสูตรแกนกลางคอมพิวเตอร์"
    core_curriculum_p: "เราได้พัฒนารูปแบบการสอนของเราตามทฤษฎีที่ได้รับการพิสูจน์แล้วและมีหลักฐานมากมายเกี่ยวกับวิธีการเรียนรู้ของนักเรียนได้ดีที่สุด"
    core_curriculum_carousel_item1_header: "การเชื่อมโยง"
    core_curriculum_carousel_item1_p: "ในช่วงเริ่มต้นของทุกโมดูล ให้ใช้สไลด์บทเรียนของเราเพื่อที่จะได้ช่วยให้นักเรียนของคุณสามารถเชื่อมโยงแนวคิดใหม่ๆของวิทยาการคอมพิวเตอร์และตัวอย่างที่เกี่ยวข้องกับชีวิตประจำวันของพวกเขา"
    core_curriculum_carousel_item2_header: "สร้างความหมายในหัว"
    core_curriculum_carousel_item2_p: "ถัดไป แนะนำนักเรียนของคุณสำหรับการสร้างความเข้าใจอย่างลึกซึ้งด้วยกิจกรรมการเขียนโค้ดแบบออฟไลน์ต่างๆ(unplugged) และให้พวกเขาได้นำเสนอหน้าชั้นเรียน"
    core_curriculum_carousel_item3_header: "เรียนรู้แนวคิดแบบใหม่"
    core_curriculum_carousel_item3_p: "ในขั้นที่สาม นักเรียนของคุณจะได้เรียนรู้แนวคิดใหม่ๆ ผ่านบทสนทนาเชิงอธิบายจากตัวละครในเรื่องราวของOzaria การพากย์เสียง กราฟิก และแอนิเมชั่นจะทำให้การซึมซับข้อมูลใหม่ๆสามารถเข้าถึงได้ง่ายและสนุกสนานมากกว่าเดิม"
    core_curriculum_carousel_item4_header: "การประยุกต์ใช้ความรู้ใหม่ๆ"
    core_curriculum_carousel_item4_p: "จากนั้น นักเรียนของคุณจะนำสิ่งที่เรียนรู้ไปปฏิบัติจริงโดยการเขียนไพธอนหรือจาวาร์สคริปต์จริงเพื่อแก้ปัญหาอุปสรรคต่างๆ ในระดับที่มีทั้งความง่ายเพื่อเป็นฐานแต่ก็ความยากเพื่อนำไปสู่เป้าหมายหรือการประยุกต์ใช้ พร้อมกับคำแนะนำเพื่อเป็นในตัวช่วยให้นักเรียนได้พบและแก้ไขจุดบกพร่อง นำไปสู่ความมั่นใจในการเขียนโค้ดมากยิ่งขึ้นในอนาคต"
    core_curriculum_carousel_item5_header: "ความท้าทายท้ายคาบ"
    core_curriculum_carousel_item5_p: "ในตอนท้ายของแต่ละชั่วโมงเรียน คุณอาจจะท้าทายเพื่อให้นักเรียนของคุณใช้ความคิดสรา้งสรรค์และทักษะใหม่ๆที่ได้ไประหว่างชั่วโมงเรียนด้วยการที่ให้พวกเขาได้สร้างเกม เรื่องราว หรืออื่นๆที่เกี่ยวข้องตามเห็นสมควร"
    core_curriculum_scope_sequence: "ดูแผนการเรียน"
    core_curriculum_sample_lesson_slides: "ดูตัวอย่างสไลด์บทเรียน"
    global_community_header: "เข้าร่วมชุมชนระดับโลกของเรา"
    global_community_row1_p: "ผู้เรียน"
    global_community_row2_p: "บรรทัด"
    global_community_row3_p: "คุณครู"
    global_community_row4_p: "ประเทศ"
    admin_dashboard_header: "แดชบอร์ดของคุณครูและผู้ดูแลระบบ"
    admin_dashboard_p: "Ozaria ได้รับการออกแบบจากความคิดเห็นจากชุมชนผู้เรียนมากกว่า 140,000 ราย จัดการกับความท้าทายในการสอนวิทยาการคอมพิวเตอร์ด้วยการจัดหาเครื่องมือและทรัพยากรที่ใสามารถช้งานได้จริง"
    admin_dashboard_row1_p: "แดชบอร์ดของคุณครูที่ใช้งานง่ายช่วยให้สามารถเข้าถึงแผนการสอนแบบพบปะกับนักเรียน คู่มือการกำหนดจังหวะ กลยุทธ์การเรียนรู้ทางไกล และทรัพยากรอื่นๆเพื่อรองรับความต้องการของคุณ"
    admin_dashboard_row2_p: "หน้าที่คอยติดตามความคืบหน้าช่วยให้คุณสามารถติดตามความก้าวหน้าของนักเรียนได้อย่างต่อเนื่อง รับข้อมูลอันมีค่าเกี่ยวกับผลการเรียนของพวกเขา และระบุได้ทันทีว่าจำเป็นต้องมีการช่วยเหลือหรือแทรกแซงหรือไม่"
    admin_dashboard_row3_a: "ขอใบกำกับภาษี"
    acodus_awards_a: "ทดลองบทที่ 1 ฟรี!"
    speech_bubble_testimonial_2_blockquote: "นี่มันเป็นไซต์เขียนโปรแกรมที่มียอดการเข้าถึงมากที่สุดที่ฉันเคยเห็นมา ฉันขอชื่นชมเรื่องราวที่ที่อยู่ภายใน Ozaria เนื่องจากสอดคล้องกับภารกิจที่นักเรียนของฉันสามารถเรียนรู้ได้ บอกตามตรงนะ อันที่จริงฉันพบว่าตัวเองเล่นเว็บไซต์นี้นานมากกว่าที่จะยอมรับได้ตลอดวันหยุดยาวที่ผ่านมา!"
    shareable_resources_header: "ทรัพยากรที่สามารถแชร์ได้"
    shareable_resources_p: "แบ่งปันแหล่งข้อมูลด้านล่างกับครู ผู้บริหาร และคนอื่นๆที่เกี่ยวข้องกับการนำวิทยาการคอมพิวเตอร์มาสู่โรงเรียนของคุณหรือขยายข้อเสนอที่คุณมีอยู่แล้ว"
    shareable_resources_a: "ดาวน์โหลดใบปลิว"
    back_cta_2_a: "ทดลองบทที่ 1 ฟรี!"
    faq_header: "คำถามที่พบบ่อย"
    faq_row1_header: "Ozaria เกี่ยวข้องกับCodeCombatอย่างไร"
    faq_row1_p: "Ozaria คือวิวัฒนาการที่เน้นใช้งานในห้องเรียนของCodeCombatซึ่งเป็นหนึ่งในเกมเขียนโค้ดที่ได้รับความนิยมมากที่สุดในประวัติศาสตร์ เราสร้างOzariaจากข้อมูลเชิงลึกที่ได้รับจากการสอนไพธอนและจาวาร์สคริปต์ให้กับผู้เรียนมากกว่า 20 ล้านคน Ozariaรวมเอาโมเดลการสอนใหม่ๆ การเล่าเรื่องที่ขับเคลื่อนด้วยเรื่องราวที่สมจริง และได้รับการออกแบบมาให้นำไปใช้ในห้องเรียนสำหรับทั้งในสภาพแวดล้อมการเรียนรู้ด้วยตนเองหรือจากระยะไกล"
    faq_row2_header: "อายุหรือชั้นปีใดที่เหมาะกับ Ozaria"
    faq_row2_p: "Ozaria สอดคล้องกับมาตรฐานวิทยาการคอมพิมเตอร์ของโรงเรียนมัธยมศึกษาตอนต้นตามที่ CSTA และ ISTE ได้ระบุเอาไว้ แต่นักเรียนตั้งแต่ระดับประถมศึกษาตอนปลายจนถึงมัธยมปลายก็สามารถรับการฝึกฝนและเพลิดเพลินไปกับเราได้"
    faq_row3_header: "มีค่าใช้จ่ายเท่าไร?"
    faq_row3_p_part1: "เราปรับแต่งโซลูชันสำหรับโรงเรียนและเขตการศึกษา และทำงานร่วมกับคุณเพื่อทำความเข้าใจแยกเป็นแต่ละกรณีการใช้งาน บริบท และงบประมาณของคุณ "
    faq_row3_p_part2: " สำหรับรายละเอียดเพิ่มเติม! นอกจากนี้เรายังมี "
    faq_row3_p_part3: "คู่มือทรัพยากรเงินทุน"
    faq_row3_p_part4: " สำหรับหลักสูตรวิทยาการคอมพิวเตอร์ของโรงเรียนและเขตการศึกษา"
    faq_row4_header: "Ozaria มีการเรียนรู้ตามหลักสูตรพื้นฐานหรือไม่"
    faq_row4_p: "ใช่. Ozaria รวบรวม Capstone Projects ที่สามารถแชร์ได้ไว้ในตอนท้ายของแต่ละบท โดยให้นักเรียนสร้างเกมของตนเอง โปรเจ็กต์เหล่านี้ทำหน้าที่เป็นการประเมินเชิงสรุปและเป็นวิธีที่ดีเยี่ยมสำหรับนักเรียนในการแสดงออกและแสดงการเรียนรู้ต่อเพื่อนร่วมชั้น เพื่อน และครอบครัว"
    faq_row5_header: "ฉันสามารถใช้ Ozaria เป็นหลักสูตรหลักของชั้นเรียนได้ไหม"
    faq_row5_p: "แน่นอนอยู่แล้ว! Ozaria มีทุกสิ่งที่คุณต้องการในชั้นเรียนวิทยาการคอมพิวเตอร์เต็มรูปแบบ แม้ว่าคุณจะไม่มีพื้นฐานวิทยาการคอมพิวเตอร์ก็ตาม ตั้งแต่แผนการสอนและคำแนะนำในการแก้ปัญหาไปจนถึงรูบริกของโครงการและการจัดตำแหน่งมาตรฐานในตัว ทั้งหมดนี้อยู่ที่นี่แล้ว"
    faq_row6_p_part1: "หากคุณมีคำถามอื่น ๆ โปรด "
    see_faq_prefix: "ดูเพิ่มเติมได้ที่"
    see_faq_link: "คำถามที่พบบ่อยในศูนย์ช่วยเหลือของเรา"
    see_faq_suffix: "."
    summary: "Ozaria เป็นโปรแกรมวิทยาการคอมพิวเตอร์ เกมผจญภัย และเรื่องราวแฟนตาซีที่นักเรียนจะได้ฝึกฝนทักษะการเขียนโค้ดที่สูญหายไปเพื่อปกป้องโลกของพวกเขา"
    value_prop1_h1: "เรื่องราวระดับอีปิค การเล่นเกมที่ดื่มด่ำ"
    value_prop1_h2: "สร้างแรงบันดาลใจในการเชื่อมต่อที่ลึกซึ้งยิ่งขึ้นกับการเรียนรู้"
    value_prop1_p: "ใน Ozaria นักเรียนจะพบว่าตนเองอยู่ในโลกใหม่ที่พวกเขาเชี่ยวชาญแนวคิดหลักด้านวิทยาการคอมพิวเตอร์เพื่อความก้าวหน้าภายในเกม การเล่าเรื่องที่เปิดเผยจะสร้างประสบการณ์การเรียนรู้ที่เน้นนักเรียนเป็นศูนย์กลาง โดยการลงทุนของนักเรียนแต่ละคนในเรื่องราวของ Ozaria ควบคู่ไปกับการลงทุนที่พวกเขากำลังทำในเส้นทางการเรียนรู้ของตนเอง"
    value_prop2_h1: "ค้นพบฮีโร่ในตัวนักเรียนทุกคน"
    value_prop2_h2: "สร้างทักษะในชีวิตจริงผ่านการเล่นเกม"
    value_prop2_p: "แนวคิดและทักษะต่างๆ ได้รับการแนะนำผ่านความก้าวหน้าของเนื้อหาที่ได้รับการออกแบบอย่างพิถีพิถัน ซึ่งรวมถึงระดับเกม บทสนทนาของตัวละครที่แนะนำ คัตซีน และอื่นๆ อีกมากมาย นักเรียนเรียนรู้การพิมพ์ Python หรือ JavaScript การแก้ปัญหาโดยใช้การคิดเชิงคำนวณ แสดงให้เห็นความเข้าใจผ่านการประเมินรายทาง และนำสิ่งที่เรียนรู้ไปใช้โดยการสร้างโครงงานของตนเอง"
    value_prop3_h1: "เริ่มการเดินทางของคุณได้ฟรี"
    value_prop3_p: "สอนผ่านการผจญภัยด้วยเนื้อหาฟรีที่ครอบคลุมแนวคิดวิทยาการคอมพิวเตอร์เบื้องต้น พร้อมสิทธิ์เข้าถึงคู่มือการใช้งานและแผนการสอน"
    projects_inspire_heading: "โครงการที่สร้างแรงบันดาลใจ ทรัพยากรที่เสริมพลัง"
    student_creativity: "ปลดปล่อยความคิดสร้างสรรค์ของนักเรียน"
    student_creativity_paragraph: "ในตอนท้ายของแต่ละหน่วย นักเรียนใช้สิ่งที่เรียนรู้โดยการสร้างโครงงาน ตั้งแต่เกมไปจนถึงการเลือกเรื่องราวการผจญภัยของคุณเอง และอื่นๆ สร้างขึ้นด้วยเป้าหมายที่สนับสนุน แต่ยังให้ความคิดที่ไร้ขีดจำกัด นักเรียนสร้างผลงานที่สามารถแชร์และเล่นได้ซึ่งแสดงถึงเอกลักษณ์ที่สร้างสรรค์ของพวกเขา"
    teach_with_support: "สนับสนุนการสอน"
    teach_with_support_paragraph: "Ozaria สร้างขึ้นเพื่อนักการศึกษาแต่ละหน่วยตลอดหลักสูตร มีแผนบทเรียนที่ระบุวัตถุประสงค์การเรียนรู้ ความเข้าใจผิดที่พบบ่อยของนักเรียน คำศัพท์สำคัญและมาตรฐานCSTA นอกจากนี้แดชบอร์ดของคุณครูที่ครอบคลุมยังช่วยให้ครูติดตามความก้าวหน้าของนักเรียนและตรวจสอบรหัสนักเรียนได้"
    request_demo: "ร้องขอการสาธิต"
    im_an_educator: "ฉันเป็นคุณครู"
    im_a_student: "ฉันเป็นนักเรียน"
    global_title: "เข้าร่วมคอมมูนิตี้ของนักเรียนและคุณครูระดับโลกกับเรา"
    global_subtitle1: "ผู้เรียน"
    global_subtitle2: "บรรทัด"
    global_subtitle3: "คุณครู"
    global_subtitle4: "ประเทศ"
    sign_up: "ลงทะเบียน"
    individual_account_warning: "คุณเข้าสู่ระบบด้วยบัญชี __name__ ซึ่งเป็นบัญชีธรรมดา Ozariaนั้นจะเข้าถึงได้โดยบัญชีคุณครูหรือนักเรียนเท่านั้น; คุณต้องการอัปเดตบัญชีของคุณหรือไม่?"
    learner_number: "12 ล้าน"
    code_line_number: "โค้ด 1 พันล้าน"
    dei_initiatives: "Ozaria มีความคิดริเริ่มอะไรบ้างเพื่อรับรองความหลากหลาย ความเท่าเทียม และการไม่แบ่งแยกในเกม?"
    dei_initiatives_blurb: "Ozaria มีความมุ่งมั่นในการส่งเสริมความหลากหลาย ความเท่าเทียม และความหลากหลายภายในเกม ด้วยการนำเสนอตัวละครที่หลากหลาย โอกาสที่เท่าเทียมกัน และสภาพแวดล้อมที่ไม่แบ่งแยก Ozariaนั้นยอมรับความแตกต่างและส่งเสริมประสบการณ์ที่เป็นมิตรสำหรับผู้เล่นทุกภูมิหลังและความสามารถ สำรวจ __deipage__ ของเราเพื่อเรียนรู้เกี่ยวกับความมุ่งมั่นและความคิดริเริ่มของเราที่มีต่อคความหลากหลายภายใน Ozaria."
    dei_page: "ความหลากหลาย"
    ozaria_efficacy: "Ozariaมีเกณการประเมินผลในการปรับปรุงผลลัพธ์การเรียนรู้ในห้องเรียนอย่างไร"
    ozaria_efficacy_blurb: "เราจัดลำดับความสำคัญของประสิทธิผลผ่านการปฏิบัติและการประเมินตามหลักฐานเชิงประจักษ์ __efficacypage__ ของเรานำเสนอสถิติโดยละเอียด คำพูดจากครูผู้สอนจริง และกรณีศึกษาที่น่าสนใจซึ่งแสดงให้เห็นถึงผลกระทบในการเปลี่ยนแปลงของOzaria ด้วยการสร้างประสบการณ์การเรียนรู้ที่มีความหมายและใช้แนวทางปฏิบัติที่มีหลักฐานเชิงประจักษ์ เราออกแบบเนื้อหาที่ให้ผลลัพธ์ที่สำคัญที่สุดสำหรับครูและนักเรียน"
    efficacy_page: "ประสิทธิภาพ"
    social_learning: "Ozaria ส่งเสริมการเรียนรู้ทางสังคมและอารมณ์(SEL)หรือไม่?"
    social_learning_blurb: "ใช่! Ozariaบูรณาการการเรียนรู้ทางสังคมและอารมณ์(SEL)เข้ากับหลักสูตรอย่างแข็งขัน ผ่านกิจกรรมแบบเกม นักเรียนจะพัฒนาทักษะที่จำเป็น เช่น การตัดสินใจ การตระหนักรู้ในตนเอง การจัดการตนเอง ความตระหนักรู้ทางสังคม ทักษะความสัมพันธ์ และการตัดสินใจอย่างมีความรับผิดชอบ คุณสามารถเรียนรู้เพิ่มเติมเกี่ยวกับปรัชญาของเราได้ที่ __selpage__ ของเรา"
    sel_page: "SEL"

  new_home:
    title_coco: "CodeCombat - เกมเขียนโค้ดเพื่อเรียน Python และ JavaScript"
    title_ozar: "Ozaria - วิทยาการสารสนเทศอันแสนน่าสนใจ"
    title_cn_home: "CodeCombat | ไพธอน, จาวาสคริปต์"
